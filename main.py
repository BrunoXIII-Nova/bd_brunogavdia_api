...
users = [
    {"id": 1, "name": "Massiel", "lastname": "Colla", "fav_curso": "Comunicacion de Datos y Redes"},
    {"id": 2, "name": "Alexandra", "lastname": "Lima", "fav_curso": "Comunicacion de Datos y Redes"},
    {"id": 3, "name": "Juan", "lastname": "Aquino", "fav_curso": "Comunicacion de Datos y Redes"},
    {"id": 4, "name": "Luis", "lastname": "Canal", "fav_curso": "Comunicacion de Datos y Redes"},
    {"id": 5, "name": "Edwin", "lastname": "Jara", "fav_curso": "Comunicacion de Datos y Redes", "anime": "Bleach"}
]
...
def create_user():
    ...
    user_curso_fav = request.args.get('fav_curso')
    user_anime = request.args.get('anime')
    if user_name and user_lastname:
        new_user = {
            "id": users[-1]["id"] + 1 if users else 1,  # Auto-generar ID
            "name": user_name,
            "lastname": user_lastname,
            "fav_curso": user_curso_fav,
            "anime": user_anime
        }
        users.append(new_user)
        return jsonify(new_user), 201
